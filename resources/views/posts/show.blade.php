...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="blog-title-area">
            <ol class="breadcrumb hidden-xs-down">
                ...
                <li class="breadcrumb-item"><a
                        href="{{ route('category.single', ['slug' => $post->category->slug]) }}">{{ $post->category->title }}</a>
                </li>
                <li class="breadcrumb-item active">{{ $post->title }}</li>
            </ol>

            <span class="color-yellow"><a href="{{ route('category.single', ['slug' => $post->category->slug]) }}"
        ...
        <div class="single-post-media">
            <img src="{{ $post->imgGet() }}" alt="" class="img-fluid">
        </div><!-- end media -->
