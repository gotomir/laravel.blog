                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        @foreach($categories_for_H as $category)
                            <li class="nav-item">
                                <a class="nav-link mt-2"
                                   href="{{ route('category.single', ['slug' => $category->slug]) }}">{{ $category->title }}</a>
                            </li>
                        @endforeach
                    ...
                    @guest()
                        <ul class="list-inline">
                            <li><a href="{{ route('login.create') }}" class="lt-button btn btn-primary mt-3 ml-4"
                                   class="down-mobile">Вход</a></li>

                        </ul>
                    @endguest
                    @auth()
                        <ul class="list-inline">
                            <li><a href="{{ route('logout') }}" class="lt-button btn btn-primary mt-3 ml-4"
                                   class="down-mobile">Выход</a></li>
